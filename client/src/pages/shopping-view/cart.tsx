      ...
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div className="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
            ...
            <div className="space-y-6">
              {cartItems && cartItems.items.length > 0
                ? cartItems.items.map((item, index) => (
                    <CartItemWrapper cartItem={item} key={index} />
                  ))
                : null}
            </div>
          ...
          <CartSummary
            ...
            originalCartAmount={originalCartAmount}
          />
        </div>
      </div>
    </section>
...
function CartSummary({ totalCartAmount, originalCartAmount }: Summary) {
          ...
          <div className="space-y-2">
            ...
            <dl className="flex items-center justify-between gap-4">
              ...
              <dd className="text-base font-medium text-green-600">
                -₹{(originalCartAmount - totalCartAmount).toFixed(2)}
              </dd>
            </dl>
...
function CartItemWrapper({ cartItem }: { cartItem?: CartItemsProps }) {
  const { user } = useAppSelector((state) => state.auth);
  const { cartItems } = useAppSelector((state) => state.shopCart);
  ...
  function handleUpdateQuantity(
    ...
    if (typeOfAction == "plus") {
      ...
      if (getCartItems.length) {
        ...
        console.log(productList[getCurrentProductIndex]);
        ...
        <div className="flex items-center justify-between md:order-3 md:justify-end">
          ...
          <div className="text-end md:order-4 md:w-32">
            {cartItem?.salePrice && cartItem.salePrice > 0 ? (
              <>
                <del className="text-base font-bold text-gray-900 dark:text-white">
                  ₹ {cartItem?.price}
                </del>
