        ...
        <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
          <div className="min-w-0 flex-1 space-y-8">
            <DeliveryAddresses
              ...
              setCurrentAddress={setCurrentSelectedAddress}
            />
...
interface DeliveryAddress {
  setCurrentAddress?: React.Dispatch<React.SetStateAction<AddressProps | null>>;
  selectedId?: AddressProps | null;
}

function DeliveryAddresses({ selectedId, setCurrentAddress }: DeliveryAddress) {
